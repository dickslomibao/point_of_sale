...
class CustomerViewScreenProvider extends ChangeNotifier {
  ...
  Future<void> initData(String id) async {
    customer = await CustomerDBHelper.getSingleList(id);
    invoice = await InvoiceDBHelper.getCustomerInvoice(id);
    isLoading = false;
    notifyListeners();
  }
